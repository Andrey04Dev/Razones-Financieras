          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav" style="color: #FFF">
                       <h2>Finanzas del Sur-Razones Financieras</h3>
            ...
            <div class="container" id="container7" style="position: relative; border-radius: 20px; top: 140px; border: 2px solid; padding: 35px 20px 20px 15px; background:#FFF; color: #364C78">
                <center><h1>Razones Cobertura</h1>
                <span>Las razones de cobertura evalúan la capacidad de la empresa para cubrir los cargos fijos que resultan de sus deudas.</span></center>
                <br><br><br>
